  ...
  head: () => ({
    meta: [
      ...
      { title: "LeAlvin Global — East African Coffee Export & Trade" },
      {
        name: "description",
        content:
          "LeAlvin Global sources, processes, roasts, packs and exports Kenyan and East African coffee to buyers worldwide.",
      },
      { name: "author", content: "Le Alvin Enterprises Limited" },
